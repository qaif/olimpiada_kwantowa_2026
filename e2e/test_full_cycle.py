...
def test_pelny_cykl_etapu_od_rejestracji_do_publikacji(
    ...
    page.fill("#id_birth_date", participant_identity["birth_date"])
    # Zgody: regulamin i RODO są wymagane od każdego, zgoda opiekuna – od niepełnoletniego
    # (reguła po pełnej dacie urodzenia, patrz apps/accounts/consents.py). Etykiety niosą
    # odnośniki do dokumentów, więc pole zaznaczamy po identyfikatorze, a nie po tekście.
