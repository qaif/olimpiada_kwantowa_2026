...
menu_order: 0
source: "wp-content/plugins/quantum-olympiad-core/includes/class-legal-content.php (`QO_Legal_Content::minors()`)"
type: "DocumentPage"
parent: "dokumenty"
seed_order: 14
---
...
> **Status:** treść demonstracyjna wg README starej strony — wymaga zatwierdzenia prawnego
> i imiennego wskazania osób odpowiedzialnych uchwałą Zarządu (mówi o tym sam § 10 dokumentu).
...
5. **Plan wsparcia:** określenie bezpiecznego kontaktu, potrzeb psychologicznych, organizacyjnych i edukacyjnych oraz osób odpowiedzialnych.
6. **Dokumentacja:** karta interwencji przechowywana w zabezpieczonym rejestrze z ograniczonym dostępem.
...
*(oryginał: wyróżniony blok `div.youth-box` — w nowym CMS osobny blok treści)*
