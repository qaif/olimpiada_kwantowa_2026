...
#: ``participant_forum`` (moderacja forum, prośba organizatora z 21.09.2026) i ``ai_grading``
#: (ocena AI, prośba organizatora z 24.09.2026). Stała istnieje po to,
...
LATER_FLAGS = frozenset({"competition_creation", "participant_forum", "ai_grading"})
