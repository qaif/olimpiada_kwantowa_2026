...
from apps.accounts.processing_register import AI_GRADING_ACTIVITY, REGISTER_VERSION, activities_for

from .conftest import enable_ai
...
def test_the_row_names_anthropic_as_processor_and_the_transfer():
    recipients = " ".join(AI_GRADING_ACTIVITY.recipients)
