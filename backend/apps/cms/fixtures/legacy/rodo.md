...
- dane identyfikacyjne i kontaktowe: imię, nazwisko, e-mail, telefon oraz dane rodzica lub opiekuna prawnego, jeżeli są potrzebne;
...
**Statystyka odwiedzin.** Jeżeli wyrazisz zgodę na pasku plików cookie, serwis korzysta z Google Analytics 4, żeby policzyć odwiedziny i sprawdzić, które strony są czytane. Odbiorcą tych danych jest Google Ireland Limited (Dublin, Irlandia); dane mogą zostać przekazane do Stanów Zjednoczonych na podstawie decyzji Komisji Europejskiej z 10 lipca 2023 r. stwierdzającej odpowiedni stopień ochrony (EU-US Data Privacy Framework). Adres IP jest anonimizowany, funkcje reklamowe i Google Signals pozostają wyłączone, a dane zdarzeń są przechowywane w usłudze przez **14 miesięcy** (ustawienie retencji wybrane przez Organizatora), po czym są automatycznie usuwane. Bez zgody skrypt pomiarowy działa w trybie „zgoda odrzucona”: nie powstaje żaden plik cookie analityczny ani identyfikator użytkownika, a do Google'a trafiają wyłącznie sygnały techniczne bez identyfikatora (adres strony, typ przeglądarki, przybliżona lokalizacja z anonimizowanego adresu IP). Zgodę można wycofać w każdej chwili odnośnikiem „Ustawienia cookies” w stopce serwisu; wycofanie nie wpływa na zgodność z prawem przetwarzania sprzed wycofania. Szczegóły: [Polityka plików cookie](/dokumenty/cookies/).
...
Dane mogą otrzymać wyłącznie podmioty, które potrzebują ich do realizacji powierzonych zadań: członkowie właściwych komitetów, szkoły i placówki przeprowadzające zawody, współpracujące uczelnie, dostawcy hostingu, poczty, systemów informatycznych, kopii zapasowych i obsługi prawnej, a także organy publiczne uprawnione przepisami. Recenzenci otrzymują prace oznaczone anonimowym kodem i nie mają dostępu do danych identyfikujących autora, o ile nie jest to konieczne do rozpatrzenia sprawy.
...
Masz prawo wnieść skargę do Prezesa Urzędu Ochrony Danych Osobowych: ul. Stanisława Moniuszki 1A, 00-014 Warszawa, [uodo.gov.pl](https://uodo.gov.pl/).

Nie podejmujemy wobec uczestników decyzji wywołujących skutki prawne wyłącznie w sposób zautomatyzowany. Narzędzia informatyczne mogą wspierać sprawdzanie prac, ale kwalifikacja i rozpatrywanie odwołań pozostają pod nadzorem upoważnionych osób.

## 11. Aktualizacje

Wersja: 1.0 z 22 lipca 2026 r. Dokument może zostać zaktualizowany w razie zmiany procesu Olimpiady, prawa lub wykorzystywanych usług. Istotne zmiany zostaną zakomunikowane uczestnikom.
