    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="pokaż w menu głównym",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=wagtail.fields.StreamField(
                ...
                blank=True,
                block_lookup={
                    0: ("wagtail.blocks.CharBlock", (), {"label": "tytuł kroku", "max_length": 120}),
                    1: ("wagtail.blocks.TextBlock", (), {"label": "opis", "max_length": 300}),
                    2: ("wagtail.blocks.StructBlock", [[("title", 0), ("text", 1)]], {}),
                },
                verbose_name="kroki",
            ),
        ),
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                max_length=200,
                verbose_name="nagłówek sekcji „jak zacząć”",
            ),
        ),
        migrations.CreateModel(
            name="SiteSettings",
            fields=[
                ...
                (
                    "site_name",
                    models.CharField(
                        default="Olimpiada Kwantowa", max_length=100, verbose_name="nazwa serwisu"
                    ),
                ),
                (
                    "tagline",
                ...
                (
                    "organizer_name",
                    models.CharField(
                        default="Fundacja Quantum AI", max_length=200, verbose_name="organizator"
                    ),
                ),
                (
                    "organizer_address",
                    models.CharField(
                        blank=True,
                        default="ul. Sanocka 9/103, 02-110 Warszawa",
                        max_length=200,
                        verbose_name="adres organizatora",
                    ),
                ),
                (
                    "organizer_registry",
                ...
                (
                    "contact_phone",
                    models.CharField(
                        blank=True, default="+48 507 982 292", max_length=40, verbose_name="telefon"
                    ),
                ),
                (
                    "contact_url",
                    models.URLField(
                        blank=True, default="https://www.qaif.org/", verbose_name="strona organizatora"
                    ),
                ),
                (
                    "site",
